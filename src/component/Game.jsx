  ...
  return (
    <div className="w-4/5  m-auto ">
      <div className="mt-24 flex">
        <div className="w-1/4  rounded-lg border-3 border-[#E9C37C] p-4  ">
          ...
          <div className="px-4">
            <div className="">
              ...
              <div className="flex justify-between mt-2	">
                <div class="w-10 h-10 bg-gray-300 rounded-full flex items-center justify-center">
                  <button class="text-gray-600 font-bold text-lg focus:outline-none">
                    1
                  </button>
                </div>
                <div class="w-10 h-10 bg-gray-300 rounded-full flex items-center justify-center">
            ...
            <div className="mt-52">
              <button class="w-full   text-[#BC2F22] font-semibold py-2 px-4 border-2 border-[#BC2F22]   rounded-3xl	">
                Hủy bài
              </button>
              <button
                type="button"
                class="mt-3 w-full text-white bg-red-700 hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900"
              >
                Nộp bài
              </button>
            </div>
        ...
        <div className="w-3/4 bg-white ml-7	">
          <div className="w-4/5 m-auto ">
            <h1 className="text-xl mt-12 font-bold ">
              1.Ai là tác giả của “Dế mèn phiêu lưu ký”?
            </h1>
            <div>
              <button class="text-left w-full bg-[#F5EADA] mt-4  font-bold py-2 px-4 border border-blue-700 rounded-3xl		">
                A. Tô Hoài
              </button>
              <button class="text-left w-full bg-[#F5EADA] mt-4  font-bold py-2 px-4 border border-blue-700 rounded-3xl		">
                B. Nguyễn Tuân
...
//   questions: [
//     {
//       question: 'Ai đã viết bài thơ "Tây Tiến"?',
//       options: ["Nguyễn Du", "Hồ Chí Minh", "Xuân Diệu", "Tố Hữu"],
//       answer: "Xuân Diệu",
//     },
//     {
//       question:
//         '"Tây tiến" là chiến dịch quân sự của quân đội nào trong cuộc chiến tranh Việt Nam?',
//       options: [
//         "Quân đội Bắc Việt",
...
//         "Quân đội Liên Xô",
//       ],
//       answer: "Quân đội Việt Nam Cộng hòa",
//     },
//     {
//       question: "Trong bài thơ, chiến sĩ đi bộ trên đồi có màu gì?",
//       options: ["Đen", "Xanh rờn", "Đỏ", "Vàng"],
//       answer: "Xanh rờn",
//     },
//     {
//       question: "Cờ gì được tung bay trong bài thơ?",
//       options: [
//         "Cờ đỏ sao vàng",
//         "Cờ đen ba sao trắng",
//         "Cờ tím, cờ vàng, cờ đỏ",
//         "Cờ đỏ",
//       ],
//       answer: "Cờ đỏ",
//     },
//     {
//       question:
//         'Bài thơ "Tây Tiến" viết về sự kiện lịch sử nào của Việt Nam?',
//       options: [
//         "Khởi nghĩa Tây Sơn",
//         "Khởi nghĩa Yên Thế",
...
//         "Khởi nghĩa Hòa Hảo",
//       ],
//       answer: "Cuộc chiến tranh giành độc lập và thống nhất đất nước",
//     },
//   ],
// };
